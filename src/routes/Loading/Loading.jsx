...
const Loading = () => {
  return (
    <main className="bg-navy-blue text-white w-full h-screen grid place-content-center">
      <div className="scene">
        <h1 className="animate__animated animate__bounce text-lg font-my-raleway font-bold uppercase text-center">
          Cargando...
        </h1>
