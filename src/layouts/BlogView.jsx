      ...
      <article className="pt-8 flex max-md:flex-col-reverse justify-center items-center mx-8">
        <div className="bg-white text-dark-gray w-full max-w-[520px] h-fit p-12 pr-28 max-md:p-10 max-sm:p-6 max-sm:pt-20 max-md:pt-16">
          ...
          <div className="text-sm flex items-center w-full justify-between gap-2 pt-5">
            <Link
              to={"/blog"}
              className="bg-orange hover:bg-[#De7700] py-2 max-lg:px-2 px-4 block w-fit transition-all text-white font-my-raleway font-bold rounded-md"
            >
              Ver noticia
            </Link>
        ...
        <img
          className="w-[50%] max-md:w-[80%] max-md:mx-auto h-full -ml-16 max-md:-mb-14 z-20"
          src={FocoPicture}
