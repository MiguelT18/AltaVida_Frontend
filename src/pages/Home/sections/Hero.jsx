...
const Hero = () => {
  return (
    <section className="w-full h-screen grid place-content-center bg-[url('@assets/images/home/01_HeroHome.webp')] bg-cover bg-no-repeat bg-center bg-fixed relative px-6">
      <BlurModule>
