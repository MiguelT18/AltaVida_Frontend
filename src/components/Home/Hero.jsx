...
const Hero = () => {
	...
	return (
		<section className='w-full h-screen flex flex-col items-center justify-end relative px-6 pb-3'>
			{allImagesLoaded ? (
				<div
					style={imageStyle}
			...
			<article className='flex flex-col items-center justify-center z-20'>
				...
				<span className='animate__animated animate__infinite animate__fadeInDown block w-fit h-fit my-5  text-orange'>
					<BsChevronDoubleDown size={'2.6rem'} />
				</span>
			</article>
